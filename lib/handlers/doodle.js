...
var doodle = module.exports = {
  ...
  get: function (req, res, next) {
    db.doodle.getWithOwner(req.params.slug, function (err, doc) {
      if (err) {
        return next();
      }
      if (doc) {
        if (doc._user) {
          doc.avatar = utils.getGravatar(doc._user.email);
          doc.authorString = utils.getAuthorString() + ' by ' + doc._user.username;
        }
